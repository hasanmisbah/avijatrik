...
<?php get_sidebar(); ?>
				...
				<div class="col-md-6 content-bg">
					...
					<h5 class="author-info pull-left"><a href="<?php the_permalink() ?>/#comments"><?php comments_number('No Comment', 'One Comment', '% Comments'); ?></a></h5>
					<div style="clear:both"></div>
      ...
      <li class="rrssb-email">
        ...
        <a title="<?php _e('Share by email','cryst4l') ?>" href="mailto:?subject=Check this post - <?php the_title();?> &body= <?php the_permalink()?>&title="<?php the_title()?>" email"=""><span><?php _e(' ', 'cryst4l')?></span>
          <span class="rrssb-icon">
